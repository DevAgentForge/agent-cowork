  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-900/20 px-4 py-8 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl border border-ink-900/5 bg-surface p-6 shadow-elevated">
        ...
        <p className="mt-2 text-sm text-muted">{t("startSession.description")}</p>
        <div className="mt-5 grid gap-4">
          <label className="grid gap-1.5">
            ...
            <div className="flex gap-2">
              ...
              >
                {t("startSession.browse")}
              </button>
            </div>
            {recentCwds.length > 0 && (
              <div className="mt-2 grid gap-2 w-full">
                <div className="text-[11px] font-medium uppercase tracking-wide text-muted-light">{t("startSession.recent")}</div>
          ...
          <label className="grid gap-1.5">
            ...
            <textarea
              ...
              placeholder={t("startSession.promptPlaceholder")}
              value={prompt}
